...
class CV2VideoReader:
    def __init__(self, path, **kwargs):
        ...
        self.cnt = int(self.cap.get(cv2.CAP_PROP_FRAME_COUNT))
    ...
    def __getitem__(self, idx):
        ...
        return type('',(),{'asnumpy':lambda self: f})()
...
class FaceDataset(Dataset):
    ...
    def get_syncnet_input(self, video_path):
        ...
        """
        # Replacement for decord.AudioReader
        video_path = ensure_wav(video_path) # Helps if mp4 load fails? ensure_wav returns .wav path if exists
        wav, sr = librosa.load(video_path, sr=16000)
